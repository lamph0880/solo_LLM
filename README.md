...
| 테스트 이미지 | 요청 | 결과 |
| :--- | :--- | :--- |
| ![식대 영수증](images/test1.png) <br> | 법령 및 규정 집에 있는 내용 요청 | 관련 pdf 파일에서 내용을 찾아 결과 표출 |
| ![물품 영수증](images/test5.png) <br> | 계획pdf 를 넣고 부적정인지 판단 요청 | 관련 pdf에 검색할 키워드 설정 및 판단, 추가 정보 요청 |
