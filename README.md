...
| :--- | :--- | :--- |
| **test1.png (식대)** | OCR 텍스트 내 '소주' 키워드 및 결제 시간(22:45) 포착 | **[부적정]** 주류 포괄 결제 및 심야 사용 규정 위반 |
| **test5.png (물품)** | 고가 GPU(285만원) 단가 및 품목 분석 → 자산 취득 규정 대조 | **[확인필요]** 자산 등록 대상 및 중앙구매 절차 이행 여부 |
